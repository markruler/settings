...
# curl -LO https://raw.githubusercontent.com/markruler/settings/main/setup-ubuntu.sh
...
# # "unbound variable" error occured when using source command
# sdk version
...
if [ -z ${XDG_CURRENT_DESKTOP+x} ]; then
  echo "XDG_CURRENT_DESKTOP is unbound variable"
else
