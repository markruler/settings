...
- [SonarLint](https://plugins.jetbrains.com/plugin/7973-sonarlint): 문제의 소지가 될 수 있는 코드 알림 ([Static program analysis](https://en.wikipedia.org/wiki/Static_program_analysis)), Preferences > Tools > SonarLint > Rules > Restore Defaults
